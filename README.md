...
>   * = 점진적 모형
>   * 점진적으로 개발 과정이 반복되므로 누락되거나 추가된 요구사항을 첨가할 수 있고, 정밀하며, 유지모수 과정이 필요 없음
> * 애자일 모형
...
>     * 태스크를 할당할 때는 개발자가 원하는 태그크를 직접 선별하여 담당할 수 있도록 하는 것이 좋음
>   * 일일 스크럼 회의
>     * 모든 팀원이 매일 약속된 시간에 약 15분 정도의 짧은 시간동안 진행 상홍을 점검
>     * 남은 작업 시간은 소멸 차트에 표시
>   * 스프린트 검토 회의
...
> * XP
>   * 수시로 발생하는 고객의 요구사항에 유연하게 대응하기 위해 고객의 참여와 개발 과정의 반복을 극대화하영 개발 생산성을 향상시키는 방법
...
>   * 개발에 참여한는 이해관계자들 간의 의사소통을 원할하게 하는데 도움을 줌 
> * 요구사항의 유형
...
> * UML의 개요
>   * 시스템 분석, 설계, 구현 등 시스템 개발 과정에서 시스템 개발자와 고객 또는 개발자 상호간의 의사소통이 원활하게 이루어지도록 표준화한 대표적인 객체지형 모델링 언어
>   * 객체지향 방법론의 장점을 통합
